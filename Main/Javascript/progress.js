...
var bar_length = 500; // the bar will be this many pixels long
...
var bar_perc = Math.round(100 / image_count);
	...
	// as long as it has not reached the next bar_part
	 if(document.getElementById('sketchlogo')){
	 if (new_width <= parseFloat((1-(document.getElementById('sketchlogo').style.opacity))*500)
